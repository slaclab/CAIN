...
# Usage example:  ./runRande+e-.sh v00507 
JOBID=$1
...
echo " JOBID= " $JOBID   " JOBDIR= " $JOBDIR  " RANDNC= " $RANDNC




cd $CA/out/"$JOBDIR"
#cp ../../in/e+e-IP.i  e+e-IP_"$JOBDIR".i
sed -i "s!^ *SET Rand=.*!SET Rand=$RANDNC;!"  e+e-IP_"$JOBDIR".i
