...
$CA/exe../../exec/cain.exe < Higgs4CP_"$JOBDIR".i > log_Higgs4CP_"$JOBDIR".txt 2>&1
...
cp $CA/in/HiggsIP_zoomInHighEcmRange.i HiggsIP_"$JOBDIR".i
$CA/exe../../exec/cain.exe < HiggsIP_"$JOBDIR".i > log_HiggsIP_"$JOBDIR".txt 2>&1
