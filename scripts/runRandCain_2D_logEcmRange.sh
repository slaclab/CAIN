...
$CA/scripts/ps2pdfRotate.sh Higgs4CP_"$JOBDIR"_ComptonPlots
mv ComptonPlots2.top Higgs4CP_"$JOBDIR"_ComptonPlots2.top
td Higgs4CP_"$JOBDIR"_ComptonPlots2.top POSTSCRIPT
$CA/scripts/ps2pdfRotate.sh Higgs4CP_"$JOBDIR"_ComptonPlots2
mv ComptonPlots3.top Higgs4CP_"$JOBDIR"_ComptonPlots3.top
td Higgs4CP_"$JOBDIR"_ComptonPlots3.top POSTSCRIPT
$CA/scripts/ps2pdfRotate.sh Higgs4CP_"$JOBDIR"_ComptonPlots3
mv Plots.top Higgs4CP_"$JOBDIR"_Plots.top
td Higgs4CP_"$JOBDIR"_Plots.top POSTSCRIPT
$CA/scripts/ps2pdfRotate.sh Higgs4CP_"$JOBDIR"_Plots
rm *.ps

cd $CA/out/"$JOBDIR"
cp $CA/in/HiggsIP_2D_logEcmRange.i HiggsIP_"$JOBDIR".i
...
then
    ...
    $CA/scripts/ps2pdfRotate.sh IncPair_"$JOBDIR"
fi
