...
bfieldext=5.,
laserwl=23.8*nm, lambar=laserwl/(2*Pi), omegal=Hbarc/lambar,
incpair=1,
cfbeamstr=1,
cfpair=1,
pushexternal=0,
...
betagammax=2*Pi*agammax^2/laserwl,
betagammay=2*Pi*agammay^2/laserwl,
   rlx=betagammax,
   rly=betagammay,
   sigt=betagamma,
pulseE=0.72,
...
LASER LEFT, WAVEL=laserwl, POWERD=powerd,
 ...
 LASER RIGHT, WAVEL=laserwl, POWERD=powerd,
      ...
      TDL=(2,2), STOKES=(0,1,0) ;
!
LASERQED  COMPTON, NPH=3, NY=100, NXI=100, NLAMBDA=100, XIMAX=1.1*xi, LAMBDAMAX=1.1*lambda, PSTOP=1000 ;
LASERQED  BREITW, NPH=3, NY=100, NXI=100, NQ=100, XIMAX=1.1*xi, ETAMAX=1.1*eta, PSTOP=1000 ;
