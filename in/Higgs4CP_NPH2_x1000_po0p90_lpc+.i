...
LASER RIGHT, POWERD=powerd,
     ...
     TDL=(d1,d2), STOKES=(0,1,0) ;
!
LASERQED  COMPTON, NPH=2, NY=200, NXI=200, NLAMBDA=200, XIMAX=1.1*xi, LAMBDAMAX=1.1*lambda, PSTOP=1000 ;
!LASERQED  BREITW, NPH=2, NY=200, NXI=200, NQ=200, XIMAX=1.1*xi, ETAMAX=1.1*eta, PSTOP=1000 ;
