...
SET wpltmx=Max(150.d9,wmax);
!!
LUMINOSITY  KIND=(photon,photon), W=(0.,wpltmx,1500), HELICITY,
  E1=(0.,75d9,75), E2=(0.,75d9,75), 
        WX=(8*sigx,16*sigx),WY=(10*sigy,16*sigy), FREP=nbunch*reprate ;
LUMINOSITY  KIND=(electron,electron), W=(0.,wpltmx,1500), HELICITY;
LUMINOSITY  KIND=(photon,electron), W=(0.,wpltmx,1500), HELICITY;
LUMINOSITY  KIND=(electron,photon), W=(0.,wpltmx,1500), HELICITY;
LUMINOSITY  KIND=(photon,positron), W=(0.,wpltmx,1500);
LUMINOSITY  KIND=(positron,photon), W=(0.,wpltmx,1500);
LUMINOSITY  KIND=(electron,positron), W=(0.,wpltmx,1500), HELICITY ;
LUMINOSITY  KIND=(positron,electron), W=(0.,wpltmx,1500), HELICITY ;
LUMINOSITY  KIND=(positron,positron), W=(0.,wpltmx,1500), HELICITY ;
...
!BBFIELD  NX=128, NY=128, WX=8*sigx, R=sigx/sigy, WXMAX=16*sigx;
 ...
 IF cfbeamstr > 0;
   CFQED BEAMSTRAHLUNG, POL, WENHANCE=wenhbeam, PMAX=pmaxbeam;
 ENDIF;

 IF cfpair > 0;
   CFQED PAIR, POL, WENHANCE=wenhpair, PMAX=pmaxpair;
 ENDIF;
...
!  Turn on incoherent pair
 IF incpair > 0;
   ...
   PPINT BW, ENHANCE=wenhpp;
   PPINT BH, ENHANCE=wenhpp;
   PPINT LL, ENHANCE=wenhpp;
 ENDIF;
...
ENDIF;
 ...
 PUSH  Time=(tmin,tmax,nstepip) ;
    IF Mod(it,1)=0;
PRINT it, Time/1e-3, NParticle(1,1,'En>30e9'),  SigX(1,1,'En>30e9')/nm,  SigY(1,1,'En>30e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Right-going E> 30 GeV',' nPhotons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(1,1,'En>60e9'),  SigX(1,1,'En>60e9')/nm,  SigY(1,1,'En>60e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Right-going E> 60 GeV',' nPhotons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(2,1,'En>30e9'),  SigX(2,1,'En>30e9')/nm,  SigY(2,1,'En>30e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Left-going E> 30 GeV',' nPhotons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(2,1,'En>60e9'),  SigX(2,1,'En>60e9')/nm,  SigY(2,1,'En>60e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Left-going E> 60 GeV',' nPhotons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(1,2,'En>30e9'),  SigX(1,2,'En>30e9')/nm,  SigY(1,2,'En>30e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Right-going E> 30 GeV',' nElectrons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(1,2,'En>60e9'),  SigX(1,2,'En>60e9')/nm,  SigY(1,2,'En>60e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Right-going E> 60 GeV',' nElectrons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(2,2,'En>30e9'),  SigX(2,2,'En>30e9')/nm,  SigY(2,2,'En>30e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Left-going E> 30 GeV',' nElectrons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(2,2,'En>60e9'),  SigX(2,2,'En>60e9')/nm,  SigY(2,2,'En>60e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Left-going E> 60 GeV',' nElectrons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(1,3,'En>30e9'),  SigX(1,3,'En>30e9')/nm,  SigY(1,3,'En>30e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Right-going E> 30 GeV',' nPositrons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(1,3,'En>60e9'),  SigX(1,3,'En>60e9')/nm,  SigY(1,3,'En>60e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Right-going E> 60 GeV',' nPositrons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(2,3,'En>30e9'),  SigX(2,3,'En>30e9')/nm,  SigY(2,3,'En>30e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Left-going E> 30 GeV',' nPositrons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(2,3,'En>60e9'),  SigX(2,3,'En>60e9')/nm,  SigY(2,3,'En>60e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Left-going E> 60 GeV',' nPositrons=',E12.4,' SigX (nm)= ',E12.4,' SigY (nm)= ',E12.4);
      PRINT STAT;
PRINT CPUTIME, LONG;
    ENDIF;
...
!!
    ENDIF;
!IF Abs(Time+2.0e-5) < 0.15e-5 || nstepip-it < 5;
!PLOT  BBFIELD, S=(-3.1e-6,-3.3e-6,-3.5e-6,-3.7e-6,-3.9e-6),
!  IF Mod(it,5)=0 || nstepip-it < 5;
!PLOT  BBFIELD, S=-3.5e-6,
! APPEND,FILE='BBField.top';
!ENDIF;
!!
    SET it=it+1;
 ENDPUSH;
...
!!
IF outputip = 1;
 WRITE BEAM, KIND=(photon,electron,positron), FILE='outputip.dat';
ENDIF;
...
DRIFT EXTERNAL, T=100*cm;
  IF incpair > 0;
PLOT SCAT, INCP, COLOR='BLUE', MAXNP=10000, H=X/cm, V=Y/cm,
  FILE='IncPair.top', RIGHT, APPEND,
  HTITLE='X (cm);', VTITLE='Y (cm);', HSCALE=(-20,20), VSCALE=(-20,20), TITLE=' Right-going Incp T=100 cm X vs Y;';

PLOT SCAT, INCP, COLOR='BLUE', MAXNP=10000, H=X/cm, V=Y/cm,
  FILE='IncPair.top', LEFT, APPEND,
  HTITLE='X (cm);', VTITLE='Y (cm);', HSCALE=(-20,20), VSCALE=(-20,20), TITLE=' Left-going Incp T=100 cm X vs Y;';

 PLOT  HIST, INCP, H=Sqrt[X^2+Y^2]/cm, HSCALE=(0,20,100), VSCALE=(1,2E10), VLOG, COLOR='BLUE', 
  FILE='IncPair.top', RIGHT, APPEND,
  TITLE='Radius Right-going Incp T=100 cm;',
        HTITLE='R  (cm);', VTITLE=' Nparticles;';

PLOT  HIST, INCP, H=Sqrt[X^2+Y^2]/cm, HSCALE=(0,20,100), VSCALE=(1,2E10), VLOG, COLOR='BLUE', 
  FILE='IncPair.top', LEFT, APPEND,
  TITLE='Radius Left-going Incp T=100 cm;',
        HTITLE='R  (cm);', VTITLE=' Nparticles;';

PLOT SCAT, INCP, COLOR='BLUE', MAXNP=100000, H=Sqrt[X^2+Y^2]/cm, V=En/1E9, VLOG,
  FILE='BgndPlotsChgPtvsR.top', RIGHT, APPEND,
 HTITLE='R (cm);', VTITLE='E(GeV);', HSCALE=(0,20), VSCALE=(.000001,100), TITLE=' Right-going Incp T=100 cm E vs R;';

PLOT SCAT, INCP, COLOR='BLUE', MAXNP=100000, H=Sqrt[X^2+Y^2]/cm, V=En/1E9, VLOG,
  FILE='BgndPlotsChgPtvsR.top', LEFT, APPEND,
 HTITLE='R (cm);', VTITLE='E (GeV);', HSCALE=(0,20), VSCALE=(.000001,100), TITLE=' Left-going Incp T=100 cm E vs R;';
...
PLOT SCAT, KIND=(2,3), COLOR='BLUE', MAXNP=10000, H=S/cm, V=X/cm,
  FILE='BackgroundPlots.top', APPEND, 
SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  HTITLE='S (cm);', VTITLE='X (cm);', HSCALE=(-300,300), VSCALE=(-20,20), TITLE=' T=100 cm X vs S;';


PLOT SCAT, KIND=(2,3), COLOR='BLUE', MAXNP=10000, H=S/cm, V=Y/cm,
  FILE='BackgroundPlots.top', APPEND, 
SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  HTITLE='S (cm);', VTITLE='Y (cm);', HSCALE=(-300,300), VSCALE=(-20,20), TITLE=' T=100 cm Y vs S;';


PLOT SCAT, KIND=(2,3), COLOR='BLUE', MAXNP=10000, H=X/cm, V=Y/cm,
  FILE='BackgroundPlots.top', RIGHT, APPEND,
  HTITLE='X (cm);', VTITLE='Y (cm);', HSCALE=(-300,300), VSCALE=(-20,20), TITLE=' Right-going T=100 cm X vs Y;';
PLOT SCAT, NONEWPAGE, KIND=1, COLOR='RED', MAXNP=10000;

PLOT SCAT, KIND=(2,3), COLOR='BLUE', MAXNP=10000, H=X/cm, V=Y/cm,
  FILE='BackgroundPlots.top', LEFT, APPEND,
  HTITLE='X (cm);', VTITLE='Y (cm);', HSCALE=(-300,300), VSCALE=(-20,20), TITLE=' Left-going T=100 cm X vs Y;';
PLOT SCAT, NONEWPAGE, KIND=1, COLOR='RED', MAXNP=10000;


PLOT SCAT, KIND=(2,3), COLOR='BLUE', MAXNP=10000, H=Sqrt[X^2+Y^2]/cm, V=En/1E9, VLOG,
  FILE='BgndPlotsChgPtvsR.top', APPEND,
 HTITLE='R (cm);', VTITLE='E (GeV);', HSCALE=(0,20), VSCALE=(.000001,100), TITLE=' Charged T=100 cm Energy vs R;';

PLOT SCAT, KIND=1, COLOR='RED', MAXNP=10000, H=Sqrt[X^2+Y^2]/cm, V=En/1E9, VLOG,
  FILE='BgndPlotsPhPtvsR.top', APPEND,
 HTITLE='R (cm);', VTITLE='En (GeV);', HSCALE=(0,20), VSCALE=(.000001,100), TITLE=' Photons T=100 cm Energy vs R;';


PLOT  HIST, KIND=(2,3), H=Sqrt[X^2+Y^2]/cm, HSCALE=(0,20,100), VSCALE=(1,2E10), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  TITLE='Radius Charged (Blue)  and  Photons (Red) Right-going T=100 cm;',
        HTITLE='R  (cm);', VTITLE=' Nparticles;';
PLOT HIST, NONEWPAGE, KIND=1, COLOR='RED';
...
PLOT  HIST, KIND=(2,3), H=Sqrt[X^2+Y^2]/cm, HSCALE=(0,20,100), VSCALE=(1,2E10), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', LEFT, APPEND,
  TITLE='Radius Charged (Blue)  and  Photons (Red) Left-going T=100 cm;',
        HTITLE='R  (cm);', VTITLE=' Nparticles;';
PLOT HIST, NONEWPAGE, KIND=1, COLOR='RED';



PLOT  HIST, KIND=1, H=X/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='RED', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='X Photon (Red)  Right-going T=100 cm;',
...
PLOT  HIST, KIND=(2,3), H=X/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='X Charged (Blue)  Right-going T=100 cm;',
  HTITLE='X  (cm);', VTITLE=' Energy (GeV);';

PLOT  HIST, KIND=(2,3), H=Y/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='Y Charged (Blue)  Right-going T=100 cm;',
...
PLOT  HIST, KIND=(2,3), H=X/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', LEFT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='X Charged (Blue)  Left-going T=100 cm;',
  HTITLE='X  (cm);', VTITLE=' Energy (GeV);';

PLOT  HIST, KIND=(2,3), H=Y/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', LEFT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='Y Charged (Blue)  Left-going T=100 cm;',
  HTITLE='Y  (cm);', VTITLE=' Energy (GeV);';
...
DRIFT EXTERNAL, T=150*cm;
  IF incpair > 0;
PLOT SCAT, INCP, COLOR='BLUE', MAXNP=10000, H=X/cm, V=Y/cm,
  FILE='IncPair.top', RIGHT, APPEND,
  HTITLE='X (cm);', VTITLE='Y (cm);', HSCALE=(-20,20), VSCALE=(-20,20), TITLE=' Right-going Incp T=150 cm X vs Y;';

PLOT SCAT, INCP, COLOR='BLUE', MAXNP=10000, H=X/cm, V=Y/cm,
  FILE='IncPair.top', LEFT, APPEND,
  HTITLE='X (cm);', VTITLE='Y (cm);', HSCALE=(-20,20), VSCALE=(-20,20), TITLE=' Left-going Incp T=150 cm X vs Y;';

 PLOT  HIST, INCP, H=Sqrt[X^2+Y^2]/cm, HSCALE=(0,20,100), VSCALE=(1,2E10), VLOG, COLOR='BLUE', 
  FILE='IncPair.top', RIGHT, APPEND,
  TITLE='Radius Right-going Incp T=150 cm;',
        HTITLE='R  (cm);', VTITLE=' Nparticles;';

PLOT  HIST, INCP, H=Sqrt[X^2+Y^2]/cm, HSCALE=(0,20,100), VSCALE=(1,2E10), VLOG, COLOR='BLUE', 
  FILE='IncPair.top', LEFT, APPEND,
  TITLE='Radius Left-going Incp T=150 cm;',
        HTITLE='R  (cm);', VTITLE=' Nparticles;';

PLOT SCAT, INCP, COLOR='BLUE', MAXNP=100000, H=Sqrt[X^2+Y^2]/cm, V=En/1E9, VLOG,
  FILE='BgndPlotsChgPtvsR.top', RIGHT, APPEND,
 HTITLE='R (cm);', VTITLE='E(GeV);', HSCALE=(0,20), VSCALE=(.000001,100), TITLE=' Right-going Incp T=150 cm E vs R;';

PLOT SCAT, INCP, COLOR='BLUE', MAXNP=100000, H=Sqrt[X^2+Y^2]/cm, V=En/1E9, VLOG,
  FILE='BgndPlotsChgPtvsR.top', LEFT, APPEND,
 HTITLE='R (cm);', VTITLE='E (GeV);', HSCALE=(0,20), VSCALE=(.000001,100), TITLE=' Left-going Incp T=150 cm E vs R;';
...
PLOT SCAT, KIND=(2,3), COLOR='BLUE', MAXNP=10000, H=S/cm, V=X/cm,
  FILE='BackgroundPlots.top', APPEND, 
SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  HTITLE='S (cm);', VTITLE='X (cm);', HSCALE=(-300,300), VSCALE=(-20,20), TITLE=' T=150 cm X vs S;';


PLOT SCAT, KIND=(2,3), COLOR='BLUE', MAXNP=10000, H=S/cm, V=Y/cm,
  FILE='BackgroundPlots.top', APPEND, 
SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  HTITLE='S (cm);', VTITLE='Y (cm);', HSCALE=(-300,300), VSCALE=(-20,20), TITLE=' T=150 cm Y vs S;';


PLOT SCAT, KIND=(2,3), COLOR='BLUE', MAXNP=10000, H=X/cm, V=Y/cm,
  FILE='BackgroundPlots.top', RIGHT, APPEND,
  HTITLE='X (cm);', VTITLE='Y (cm);', HSCALE=(-300,300), VSCALE=(-20,20), TITLE=' Right-going T=150 cm X vs Y;';
PLOT SCAT, NONEWPAGE, KIND=1, COLOR='RED', MAXNP=10000;

PLOT SCAT, KIND=(2,3), COLOR='BLUE', MAXNP=10000, H=X/cm, V=Y/cm,
  FILE='BackgroundPlots.top', LEFT, APPEND,
  HTITLE='X (cm);', VTITLE='Y (cm);', HSCALE=(-300,300), VSCALE=(-20,20), TITLE=' Left-going T=150 cm X vs Y;';
PLOT SCAT, NONEWPAGE, KIND=1, COLOR='RED', MAXNP=10000;


PLOT SCAT, KIND=(2,3), COLOR='BLUE', MAXNP=10000, H=Sqrt[X^2+Y^2]/cm, V=En/1E9, VLOG,
  FILE='BgndPlotsChgPtvsR.top', APPEND,
 HTITLE='R (cm);', VTITLE='E (GeV);', HSCALE=(0,20), VSCALE=(.000001,100), TITLE=' Charged T=150 cm Energy vs R;';

PLOT SCAT, KIND=1, COLOR='RED', MAXNP=10000, H=Sqrt[X^2+Y^2]/cm, V=En/1E9, VLOG,
  FILE='BgndPlotsPhPtvsR.top', APPEND,
 HTITLE='R (cm);', VTITLE='En (GeV);', HSCALE=(0,20), VSCALE=(.000001,100), TITLE=' Photons T=150 cm Energy vs R;';


PLOT  HIST, KIND=(2,3), H=Sqrt[X^2+Y^2]/cm, HSCALE=(0,20,100), VSCALE=(1,2E10), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  TITLE='Radius Charged (Blue)  and  Photons (Red) Right-going T=150 cm;',
        HTITLE='R  (cm);', VTITLE=' Nparticles;';
PLOT HIST, NONEWPAGE, KIND=1, COLOR='RED';
...
PLOT  HIST, KIND=(2,3), H=Sqrt[X^2+Y^2]/cm, HSCALE=(0,20,100), VSCALE=(1,2E10), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', LEFT, APPEND,
  TITLE='Radius Charged (Blue)  and  Photons (Red) Left-going T=150 cm;',
        HTITLE='R  (cm);', VTITLE=' Nparticles;';
PLOT HIST, NONEWPAGE, KIND=1, COLOR='RED';
...
PLOT  HIST, KIND=1, H=X/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='RED', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='X Photon (Red)  Right-going T=150 cm;',
  HTITLE='X  (cm);', VTITLE=' Energy (GeV);';
...
PLOT  HIST, KIND=(2,3), H=X/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='X Charged (Blue)  Right-going T=150 cm;',
  HTITLE='X  (cm);', VTITLE=' Energy (GeV);';

PLOT  HIST, KIND=(2,3), H=Y/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='Y Charged (Blue)  Right-going T=150 cm;',
  HTITLE='Y  (cm);', VTITLE=' Energy (GeV);';
...
PLOT  HIST, KIND=1, H=X/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='RED', 
  FILE='BackgroundPlotsRvsS.top', LEFT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='X Photon (Red)  Left-going T=150 cm;',
  HTITLE='X  (cm);', VTITLE=' Energy (GeV);';
...
PLOT  HIST, KIND=(2,3), H=X/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', LEFT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='X Charged (Blue)  Left-going T=150 cm;',
  HTITLE='X  (cm);', VTITLE=' Energy (GeV);';

PLOT  HIST, KIND=(2,3), H=Y/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='BLUE', 
  FILE='BackgroundPlotsRvsS.top', LEFT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='Y Charged (Blue)  Left-going T=150 cm;',
  HTITLE='Y  (cm);', VTITLE=' Energy (GeV);';
...
PLOT  HIST, KIND=1, H=X/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='RED', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='X Photon (Red)  Right-going T=250 cm;',
  HTITLE='X  (cm);', VTITLE=' Energy (GeV);';
...
PLOT  HIST, KIND=1, H=X/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='RED', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='X Photon (Red)  Right-going T=300 cm;',
  HTITLE='X  (cm);', VTITLE=' Energy (GeV);';
...
PLOT  HIST, KIND=1, H=X/cm, V=(En/1D9), HSCALE=(-20,20,200), VLOG, COLOR='RED', 
  FILE='BackgroundPlotsRvsS.top', RIGHT, APPEND,
  SELECT=(En/1D9 < eplotmax && En/1D9 > eplotmin && (plotincp < 0 || Incp == plotincp)),
  TITLE='X Photon (Red)  Right-going T=350 cm;',
  HTITLE='X  (cm);', VTITLE=' Energy (GeV);';
...
!        HTITLE='Q0e1 (mrad);GX X       ;' ;
!!
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(photon,photon), FILE='HiggsLumi.top';
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(photon,electron), FILE='HiggsLumi.top', APPEND;
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(electron,photon), FILE='HiggsLumi.top', APPEND;
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(electron,electron), FILE='HiggsLumi.top', APPEND;
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(photon,positron), FILE='HiggsLumi.top', APPEND;
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(positron,photon), FILE='HiggsLumi.top', APPEND;
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(electron,positron), FILE='HiggsLumi.top', APPEND;
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(positron,electron), FILE='HiggsLumi.top', APPEND;
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(positron,positron), FILE='HiggsLumi.top', APPEND;
...
PRINT Lum(3,3),FORMAT=('luminosity e+ e+=',1pd15.8);
! 
 STOP;
