ALLOCATE MP=2000000, MVPH=2000000, MLUMMESH=256 ;
SET Rand=5223024;
...
LUMINOSITY  KIND=(photon,positron), W=(0.,150d9,1500);
 ...
 IF cfbeamstr > 0;
   CFQED BEAMSTRAHLUNG, POL, PMAX=0.8, WENHANCE=0.01;
 ENDIF;
