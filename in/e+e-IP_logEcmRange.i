ALLOCATE MP=2000000, MVPH=1600000, MLUMMESH=256 ;
SET Rand=5223024;
HEADER  'ILC e+e- Collider  xxxxxxxx;';
SET photon=1, electron=2, positron=3, 
mm=1D-3, micron=1D-6, nm=1D-9, cm=1D-2,
bfieldext=10,
ee=7500.0D9,  gamma=ee/Emass,
emax=ee,
an=0.5D10,
sigz=5.0*micron,
betax=0.15*mm,
betay=0.15*mm,
emitx=100.0*nm/gamma,
emity=100.0*nm/gamma,
nbunch=1,
sigee=0.0005,
sigep=0.0005,
reprate=2575,
...
LUMINOSITY  KIND=(electron,positron), W=(0.4*ee,2.04*ee,330), HELICITY,
  WX=(8*sigx,16*sigx), WY=(8*sigy,16*sigy), FREP=nbunch*reprate ;
...
LUMINOSITY  KIND=(photon,positron), W=(0.,150d9,1500);
 ...
 IF cfpair > 0;
   CFQED PAIR, POL, PMAX=0.99999, WENHANCE=wenhpair;
 ENDIF;
...
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(electron,positron), FILE='e+e-Lumi.top';
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(photon,photon), FILE='e+e-Lumi.top', APPEND;
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(electron,photon), FILE='e+e-Lumi.top', APPEND;
PLOT LUMINOSITY, VLOG, PERBIN, KIND=(photon,positron), FILE='e+e-Lumi.top', APPEND;
! 
