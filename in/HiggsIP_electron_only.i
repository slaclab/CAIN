...
!SET wmin=0.8*wmax;
 SET wbin=50;
!!
LUMINOSITY  KIND=(electron,electron), W=(wmin,wmax,wbin),
...
!LUMINOSITY  KIND=(positron,electron), W=(wmin,wmax,50);
...
!  Turn on incoherent pair
 ...
 PUSH  Time=(tmin,tmax,nstep) ;
    IF Mod(it,1)=0;
PRINT it, Time/1e-3, NParticle(1,2,'En>30e9'),  SigX(1,2,'En>30e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Right-going E> 30 GeV',' nElectrons=',E12.4,' SigX (nm)= ',E12.4);
PRINT it, Time/1e-3, NParticle(1,2,'En>60e9'),  SigX(1,2,'En>60e9')/nm, FORMAT=(' +++ ',F6.0,'-th time step   t=',F7.2,' mm',' Right-going E> 60 GeV',' nElectrons=',E12.4,' SigX (nm)= ',E12.4);
