...
LUMINOSITY  KIND=(photon,photon), W=(0.,wpltmx,1500), HELICITY,
  E1=(0.,epltmx,NBIN1), E2=(0.,epltmx,NBIN2), 
...
LUMINOSITY  KIND=(electron,electron), W=(0.,wpltmx,1500), HELICITY,
  E1=(0.,epltmx,NBIN1), E2=(0.,epltmx,NBIN2), 
        WX=(8*sigx,16*sigx),WY=(10*sigy,16*sigy), FREP=nbunch*reprate ;
 LUMINOSITY  KIND=(photon,positron), W=(0.,wpltmx,1500), HELICITY,
   E1=(0.,epltmx,NBIN1), E2=(0.,epltmx,NBIN2), 
         WX=(8*sigx,16*sigx),WY=(10*sigy,16*sigy), FREP=nbunch*reprate ;
 LUMINOSITY  KIND=(positron,photon), W=(0.,wpltmx,1500), HELICITY,
   E1=(0.,epltmx,NBIN1), E2=(0.,epltmx,NBIN2), 
         WX=(8*sigx,16*sigx),WY=(10*sigy,16*sigy), FREP=nbunch*reprate ;
...
DO KR=(1,3);
  DO KL=(1,3);
    DO H=(1,4);
      DO N1=(1,NBIN1);
        DO N2=(1,NBIN2);
          PRINT KR,KL,H,N1,N2,LumEEH(KR,KL,N1,N2,H),FORMAT=(' KR= ',I2,' KL= ',I2,' H= ',I2,' N1= ',I4,' N2= ',I4,' LumEEH= ',1pd15.8);
PRINT KR,KL,H,N1,N2,LumEEbinEdge(KR,KL,1,N1-1),LumEEbinEdge(KR,KL,1,N1),LumEEbinEdge(KR,KL,2,N2-1),LumEEbinEdge(KR,KL,2,N2),FORMAT=(' KR= ',I2,' KL= ',I2,' H= ',I2,' N1= ',I4,' N2= ',I4,' E1a= ',1pd15.8,' E1b= ',1pd15.8,' E2a= ',1pd15.8,' E2b= ',1pd15.8);
!234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456
        ENDDO;
      ENDDO;
    ENDDO;
  ENDDO;
