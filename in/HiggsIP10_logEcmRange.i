...
LUMINOSITY  KIND=(photon,photon), W=(0.,12d9,100), HELICITY,
        WX=(8*sigx,16*sigx),WY=(10*sigy,16*sigy), FREP=nbunch*reprate ;
LUMINOSITY  KIND=(electron,electron), W=(0.,12d9,100), HELICITY;
LUMINOSITY  KIND=(photon,electron), W=(0.,12d9,100), HELICITY;
LUMINOSITY  KIND=(electron,photon), W=(0.,12d9,100), HELICITY;
LUMINOSITY  KIND=(photon,positron), W=(0.,12d9,100);
LUMINOSITY  KIND=(positron,photon), W=(0.,12d9,100);
LUMINOSITY  KIND=(electron,positron), W=(0.,12d9,100), HELICITY ;
LUMINOSITY  KIND=(positron,electron), W=(0.,12d9,100), HELICITY ;
