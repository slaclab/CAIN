...
SET   mm=1E-3, micron=1E-6, nm=1E-9, nx=4.5, ny=4.5, nt=4.5, ne=4.5,
   ee=175E9,  gamma=ee/Emass,  an=2.00E10, nbunch=1312, reprate=5,
   sigz=0.3*mm, betax=16*mm, betay=340*micron,
   emitx=1.0E-5/gamma,  emity=3.5E-8/gamma,
   dalphadty=0, s0=0, 
   sigx=Sqrt(emitx*betax), sigy=Sqrt(emity*betay),
   sigxp=sigx/betax,  sigyp=sigy/betay,
   offstx=0.,  offsty=0.5*nm,
...
PLOT  HIST, KIND=(2,3), H=En/1E9, HSCALE=(0,1.001*ee/1E9,50), VLOG,
        ...
        HTITLE='E0e1  (GeV); X X       ;';
PLOT  SCAT, KIND=2,  MAXNP=2000,
        H=Px/Ps/micron, V=Py/Ps/micron,
        HSCALE=(-15*sigxp/micron,15*sigxp/micron),
        VSCALE=(-5*sigyp/micron,5*sigyp/micron),
...
!WRITE BEAM, KIND=1, FILE='..\out\500.SB2009.beamstrahlung.dat';
!WRITE BEAM, KIND=2, FILE='..\out\500.SB2009.e.dat';
!WRITE BEAM, KIND=3, FILE='..\out\500.SB2009.p.dat';
! WRITE LUMINOSITY,KIND=(2,3),FILE='..\out\500.SB2009.lum';
...
!  FORMAT=(G20.7," ",G20.7," ",G20.7),FILE='..\out\500.SB2009.2dlum' ;
!IF incpair > 0;
! WRITE BEAM, INCP, FILE='..\out\500.SB2009_pair.dat' ;
!ENDIF;
STOP;
