...
!!
LUMINOSITY  KIND=(photon,photon), W=(124.8d9,125.8d9,250), HELICITY,
        WX=(8*sigx,16*sigx),WY=(10*sigy,16*sigy), FREP=nbunch*reprate ;
LUMINOSITY  KIND=(electron,electron), W=(wee*lambda/(lambda+1)-10.d9,wee*lambda/(lambda+1)+10.d9,80), HELICITY;
LUMINOSITY  KIND=(photon,electron), W=(wee*lambda/(lambda+1)-10.d9,wee*lambda/(lambda+1)+10.d9,640), HELICITY;
LUMINOSITY  KIND=(electron,photon), W=(wee*lambda/(lambda+1)-10.d9,wee*lambda/(lambda+1)+10.d9,640), HELICITY;
LUMINOSITY  KIND=(photon,positron), W=(wee*lambda/(lambda+1)-10.d9,wee*lambda/(lambda+1)+10.d9,80);
LUMINOSITY  KIND=(positron,photon), W=(wee*lambda/(lambda+1)-10.d9,wee*lambda/(lambda+1)+10.d9,80);
LUMINOSITY  KIND=(electron,positron), W=(wee*lambda/(lambda+1)-10.d9,wee*lambda/(lambda+1)+10.d9,80), HELICITY ;
LUMINOSITY  KIND=(positron,electron), W=(wee*lambda/(lambda+1)-10.d9,wee*lambda/(lambda+1)+10.d9,80), HELICITY ;
LUMINOSITY  KIND=(positron,positron), W=(wee*lambda/(lambda+1)-10.d9,wee*lambda/(lambda+1)+10.d9,80), HELICITY ;
...
PLOT LUMINOSITY, KIND=(positron,positron), FILE='HiggsLumi.top', APPEND;
