...
ENDIF;
!
BEAM FILE='/mnt/c/Users/timb/ubuntu/Cain/cain242/OideStudy/BeamParticles/Beam_GammaIP_Oide_right_16000_final.txt';
!
BEAM FILE='/mnt/c/Users/timb/ubuntu/Cain/cain242/OideStudy/BeamParticles/Beam_GammaIP_Oide_left_16000_final.txt';
!
!! LASER
...
PLOT SCAT,MAXNP=10000, KIND=electron,VLOG, HLOG,
 ...
 PLOT  HIST, KIND=photon, RIGHT, H=En/1D9, HSCALE=(0,ee/1e9,100),
        FILE='Plots.top', APPEND,
        TITLE='All Right-Going Photon Energy Spectrum after CP;',
        HTITLE='E0G1 (GeV); XGX      ;'  ;
 PLOT  HIST, KIND=photon, LEFT, H=En/1D9, HSCALE=(0,ee/1e9,100),
        FILE='Plots.top', APPEND,
        TITLE='All Left-Going Photon Energy Spectrum after CP;',
        HTITLE='E0G1 (GeV); XGX      ;'  ;
 PLOT  HIST, KIND=photon, RIGHT, SELECT=(Gen==2), H=En/1D9, HSCALE=(0,ee/1e9,100),
        FILE='Plots.top', APPEND,
       TITLE='Right-Going Primary Photon Energy Spectrum after CP;',
        HTITLE='E0G1 (GeV); XGX      ;'  ;
 PLOT  HIST, LEFT,KIND=photon, SELECT=(Gen==2),H=En/1D9, HSCALE=(0,ee/1e9,100),
        FILE='Plots.top', APPEND,
