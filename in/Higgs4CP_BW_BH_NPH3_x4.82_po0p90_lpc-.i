...
sige=0.0005,
!ee=79.48D9,  gamma=ee/Emass,  
ee=83.0D9,  gamma=ee/Emass,  
an=0.63D10,  
!sigz=7.5*micron, 
!sigz=10*micron, 
sigz=30*micron, 
...
bfieldext=5.,
laserwl=327.061*nm, lambar=laserwl/(2*Pi), omegal=Hbarc/lambar,
!pulseE=0.72,
!pulseE=0.4,
incpair=1,
cfbeamstr=1,
...
!!
BEAM  RIGHT, KIND=electron, NP=200000, AN=an, E0=ee, SIGE=sige,
...
!
BEAM  LEFT,  KIND=electron, NP=200000, AN=an, E0=ee, SIGE=sige,
  TXYS=(0,0,-off/2,0),  GCUTT=ntcut, SLOPE=(crossangle/2,0), CRAB=(crabangle,0),
  BETA=(betax,betay), EMIT=(emitx,emity), SIGT=sigz, SPIN=(0,0,spinleft);
!
!! LASER
