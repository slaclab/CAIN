...
!  Takes 24 sec on DEC workstation at KEK
 ...
 ALLOCATE MP=360000000, MVPH=8000000, MLUMMESH=256, ;
!SET Rand=7627499;
!SET Rand=9885452;
!SET Rand=4819832;
!SET Rand=6528341;
...
bfieldext=5,
laserwl=0.29676*nm, lambar=laserwl/(2*Pi), omegal=Hbarc/lambar,
incpair=1,
cfbeamstr=1,
cfpair=1,
pushexternal=0,
...
!!
BEAM  RIGHT, KIND=electron, NP=1600000, AN=an, E0=ee, SIGE=sige,
...
!
BEAM  LEFT,  KIND=electron, NP=1600000, AN=an, E0=ee, SIGE=sige,
  TXYS=(0,0,-off/2,0),  GCUTT=ntcut, SLOPE=(crossangle/2,0), CRAB=(crabangle,0),
  BETA=(betax,betay), EMIT=(emitx,emity), SIGT=sigz, SPIN=(0,0,spinleft);
!
!! LASER
