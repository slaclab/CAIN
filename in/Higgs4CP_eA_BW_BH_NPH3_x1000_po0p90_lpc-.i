...
!  Takes 24 sec on DEC workstation at KEK
 ...
 ALLOCATE MP=360000000, MVPH=800000, MLUMMESH=256, ;
!SET Rand=7627499;
!SET Rand=9885452;
!SET Rand=4819832;
!SET Rand=6528341;
...
!!
BEAM  RIGHT, KIND=electron, NP=16000, AN=an, E0=ee, SIGE=sige,
...
!
BEAM  LEFT,  KIND=electron, NP=16000, AN=an, E0=ee, SIGE=sige,
  TXYS=(0,0,-off/2,0),  GCUTT=ntcut, SLOPE=(crossangle/2,0), CRAB=(crabangle,0),
  BETA=(betax,betay), EMIT=(emitx,emity), SIGT=sigz, SPIN=(0,0,spinleft);
!
!! LASER
...
!
LASER LEFT, WAVEL=laserwl, POWERD=0.00001*powerd,
